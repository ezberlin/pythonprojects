...
#beispiel
f = quadratischeFunktion("e", p1=(5,5), sp=(6,6))#mögliche parameter sind p1, p2, p3 und sp als tupel (punkte/scheitelpunkt) sowie a, b, c, d und e als int/float (parameter)
